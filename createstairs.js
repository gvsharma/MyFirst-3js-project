...
function createStairs() {
    ...
    var verticalStep = verticalStepHeight + stepThickness;
    var horizontalStep = horizontalStepDepth - stepThickness;

    // Make and position the horizontal part.
    stepMesh = new THREE.Mesh(stepVertical, stepMaterialVertical);
    stepMesh.position.x = 0;
    stepMesh.position.y = verticalStepHeight / 2 + verticalStep;
    stepMesh.position.z = horizontalStepDepth - stepThickness;
    scene.add(stepMesh);

    stepMesh = new THREE.Mesh(stepHorizontal, stepMaterialHorizontal);
    stepMesh.position.x = 0;
    stepMesh.position.y = stepThickness / 2 + verticalStepHeight + verticalStep;
    stepMesh.position.z = horizontalStepDepth / 2 - stepHalfThickness + horizontalStep;
    scene.add(stepMesh);

    // Make and position the horizontal part.
    stepMesh = new THREE.Mesh(stepVertical, stepMaterialVertical);
    stepMesh.position.x = 0;
    stepMesh.position.y = verticalStepHeight / 2 + 2 * verticalStep;
    stepMesh.position.z = 2 * (horizontalStepDepth - stepThickness);
    scene.add(stepMesh);

    stepMesh = new THREE.Mesh(stepHorizontal, stepMaterialHorizontal);
    stepMesh.position.x = 0;
    stepMesh.position.y = stepThickness / 2 + verticalStepHeight + 2 * verticalStep;
    stepMesh.position.z = horizontalStepDepth / 2 - stepHalfThickness + 2 * horizontalStep;
    scene.add(stepMesh);

    // Make and position the horizontal part.
    stepMesh = new THREE.Mesh(stepVertical, stepMaterialVertical);
    stepMesh.position.x = 0;
    stepMesh.position.y = verticalStepHeight / 2 + 3 * verticalStep;
    stepMesh.position.z = 3 * (horizontalStepDepth - stepThickness);
    scene.add(stepMesh);

    stepMesh = new THREE.Mesh(stepHorizontal, stepMaterialHorizontal);
    stepMesh.position.x = 0;
    stepMesh.position.y = stepThickness / 2 + verticalStepHeight + 3 * verticalStep;
    stepMesh.position.z = horizontalStepDepth / 2 - stepHalfThickness + 3 * horizontalStep;
    scene.add(stepMesh);

    // Make and position the horizontal part.
    stepMesh = new THREE.Mesh(stepVertical, stepMaterialVertical);
    stepMesh.position.x = 0;
    stepMesh.position.y = verticalStepHeight / 2 + 4 * verticalStep;
    stepMesh.position.z = 4 * (horizontalStepDepth - stepThickness);
    scene.add(stepMesh);

    stepMesh = new THREE.Mesh(stepHorizontal, stepMaterialHorizontal);
    stepMesh.position.x = 0;
    stepMesh.position.y = stepThickness / 2 + verticalStepHeight + 4 * verticalStep;
    stepMesh.position.z = horizontalStepDepth / 2 - stepHalfThickness + 4 * horizontalStep;
    scene.add(stepMesh);

    // Make and position the horizontal part.
    stepMesh = new THREE.Mesh(stepVertical, stepMaterialVertical);
    stepMesh.position.x = 0;
    stepMesh.position.y = verticalStepHeight / 2 + 5 * verticalStep;
    stepMesh.position.z = 5 * (horizontalStepDepth - stepThickness);
    scene.add(stepMesh);

    stepMesh = new THREE.Mesh(stepHorizontal, stepMaterialHorizontal);
    stepMesh.position.x = 0;
    stepMesh.position.y = stepThickness / 2 + verticalStepHeight + 5 * verticalStep;
    stepMesh.position.z = horizontalStepDepth / 2 - stepHalfThickness + 5 * horizontalStep;
    scene.add(stepMesh);
...
function init() {
    var canvasWidth = 1046;
    var canvasHeight = 594;
