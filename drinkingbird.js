...
function createDrinkingBird() {
    ...
    var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(5, 5, 200, 32), crossbarMaterial);
    cylinder.position.set(0, 360, 0);
    cylinder.rotation.x = 90 * Math.PI / 180;
    scene.add(cylinder);

    cylinder = new THREE.Mesh(new THREE.CylinderGeometry(6, 14, 72, 32), headMaterial);
    cylinder.position.set(-70, 530, 0);
    cylinder.rotation.z = 90 * Math.PI / 180;
    scene.add(cylinder);

    var sphereGeometry = new THREE.SphereGeometry(10, 32, 16);
    sphere = new THREE.Mesh(sphereGeometry, eyeMaterial);
